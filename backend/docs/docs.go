...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.UpsertCommunityLinkRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/models.CommunityLink"
                                        }
                                    }
                                }
                            ]
        ...
        "/admin/finance/crypto-deposits": {
            "get": {
                ...
                "description": "Admin-only: paginated crypto deposits, filterable by status and currency.",
                "produces": [
                    "application/json"
                ],
                "tags": [
                ...
                "summary": "List crypto deposits (admin)",
                "parameters": [
                    {
                        "type": "integer",
                    ...
                    {
                        "type": "string",
                        "description": "Filter by status: pending, confirmed",
                        "name": "status",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Filter by currency symbol e.g. USDT",
                        "name": "currency",
                        "in": "query"
                    }
                ],
        ...
        "/admin/finance/crypto-withdrawals": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "description": "Admin-only: paginated crypto withdrawals, filterable by status and currency.",
                "produces": [
                    "application/json"
                ],
                "tags": [
                ...
                "summary": "List crypto withdrawals (admin)",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Page number (default 1)",
        ...
        "/admin/finance/fiat-deposits": {
            "get": {
                ...
                "description": "Admin-only: paginated fiat deposits, filterable by status.",
                "produces": [
                    "application/json"
                ],
                "tags": [
                ...
                "summary": "List fiat deposits (admin)",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Page number (default 1)",
        ...
        "/admin/finance/fiat-withdrawals": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "description": "Admin-only: paginated fiat withdrawals, filterable by status.",
                "produces": [
                    "application/json"
                ],
                "tags": [
                ...
                "summary": "List fiat withdrawals (admin)",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Page number (default 1)",
        ...
        "/admin/finance/internal-transfers": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "description": "Admin-only: paginated internal transfers between users.",
                "produces": [
                    "application/json"
                ],
                "tags": [
                ...
                "summary": "List internal transfers (admin)",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Page number (default 1)",
        ...
        "/admin/finance/nomba-balance": {
            "get": {
                ...
                "description": "Admin-only: fetches the current ledger and available balance from the Nomba business account.",
                "produces": [
                    "application/json"
                ],
                "tags": [
                ...
                "summary": "Get Nomba account balance (admin)",
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/nomba.AccountBalanceData"
                                        }
                                    }
                                }
                            ]
        ...
        "/admin/finance/quidax-balances": {
            "get": {
                ...
                "description": "Admin-only: fetches all Quidax master-account wallets and returns only those with a non-zero balance.",
                "produces": [
                    "application/json"
                ],
                "tags": [
                ...
                "summary": "Get Quidax wallets with balance (admin)",
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/quidax.MeWallet"
                                            }
                                        }
                                    }
                                }
        ...
        "/admin/finance/summary": {
            "get": {
                ...
                "description": "Admin-only: total wallet balances per currency and pending deposit/withdrawal counts.",
                "produces": [
                    "application/json"
                ],
                "tags": [
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/repository.FinancialSummary"
                                        }
                                    }
                                }
                            ]
        ...
        "/admin/finance/verify-balances": {
            "get": {
                ...
                "description": "Admin-only: compares wallets.balance against SUM(balance_after - balance_before) from wallet_transactions. Returns only wallets with discrepancies. This is an expensive query — use sparingly.",
                "produces": [
                    "application/json"
                ],
                "tags": [
                ...
                "summary": "Verify wallet balances (admin)",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Filter by currency symbol e.g. USDT (default: all currencies)",
                        "name": "currency",
                        "in": "query"
                    }
                ],
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/repository.WalletVerificationResult"
                                        }
                                    }
                                }
                            ]
        ...
        "/admin/kyc": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Filter by tier: 0, 1, 2, 3",
                        "name": "tier",
                        "in": "query"
                    }
                ],
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.CreateNetworkRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.BroadcastNotificationRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/admin/p2p/orders": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Order status: pending, paid, disputed, cancelled, completed",
                        "name": "status",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Crypto currency symbol (e.g. USDT)",
                        "name": "currency",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Filter orders where user is buyer or seller (UUID)",
                        "name": "user_id",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Start date filter (RFC3339, e.g. 2026-01-01T00:00:00Z)",
                        "name": "from",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "End date filter (RFC3339, e.g. 2026-12-31T23:59:59Z)",
                        "name": "to",
                        "in": "query"
                    }
                ],
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/service.AdminP2POrderResponse"
                                            }
                                        }
                                    }
                                }
        ...
        "/admin/p2p/top-traders": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by crypto symbol (e.g. USDT)",
                        "name": "currency",
                        "in": "query"
                    }
                ],
        ...
        "/admin/referral/claim-cycles": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Claim cycle params",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.OpenClaimCycleRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/admin/referral/claim-cycles/{id}": {
            "patch": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.UpdateReferralConfigRequest"
                        }
                    }
                ],
                "responses": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/repository.DailyFeeRow"
                                            }
                                        }
                                    }
                                }
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/service.RevenueSummary"
                                        }
                                    }
                                }
                            ]
        ...
        "/admin/users": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Exact 14-digit UID",
                        "name": "uid",
                        "in": "query"
                    },
                    {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/handler.adminUserDetailResponse"
                                        }
                                    }
                                }
                            ]
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.SetUserStatusRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/admin/users/{id}/withdrawal-limit": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/service.UserLimitInfo"
                                        }
                                    }
                                }
                            ]
        ...
        "/admin/users/{id}/withdrawal-limit/override": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.setOverrideRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/auth/2fa/login": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Login credentials with 2FA code",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.TwoFALoginRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "401": {
                        "description": "invalid email or password | account is deactivated | too many failed login attempts; please try again later | 2FA not configured for this account | 2FA not enabled for this account | invalid authenticator code",
                        "schema": {
                            "$ref": "#/definitions/utils.Response"
                        }
                    },
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.VerifyTwoFARequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "401": {
                        "description": "invalid or expired pre-auth token | invalid authenticator code",
                        "schema": {
                            "$ref": "#/definitions/utils.Response"
                        }
                    },
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.SocialLoginRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "401": {
                        "description": "invalid Apple ID token | account is deactivated",
                        "schema": {
                            "$ref": "#/definitions/utils.Response"
                        }
                    },
        ...
        "/auth/forgot-password/request-otp": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Password reset OTP request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.ForgotPasswordRequestOTPRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/auth/forgot-password/resend-otp": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "If this email is registered, an OTP has been resent",
                        "schema": {
                            "$ref": "#/definitions/utils.Response"
                        }
                    },
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.ForgotPasswordResetRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        "description": "invalid or expired reset token | password must be at least 12 characters long and include upper, lower, number, and symbol | user not found | account is deactivated",
                        "schema": {
                            "$ref": "#/definitions/utils.Response"
                        }
                    },
        ...
        "/auth/forgot-password/verify-otp": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Password reset OTP verification",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.ForgotPasswordVerifyOTPRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        "description": "otp not found or expired | too many invalid otp attempts | invalid otp",
                        "schema": {
                            "$ref": "#/definitions/utils.Response"
                        }
                    },
        ...
        "/auth/google": {
            "post": {
                ...
                "responses": {
                    ...
                    "401": {
                        "description": "invalid Google ID token | account is deactivated",
                        "schema": {
                            "$ref": "#/definitions/utils.Response"
                        }
                    },
        ...
        "/auth/login": {
            "post": {
                ...
                "responses": {
                    ...
                    "202": {
                        "description": "2FA required — pre_auth_token returned",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/utils.Response"
                    ...
                    "401": {
                        "description": "invalid email or password | account is deactivated | too many failed login attempts",
                        "schema": {
                            "$ref": "#/definitions/utils.Response"
                        }
                    },
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.RequestRegistrationOTPRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "If this email is eligible for registration, an OTP has been sent",
                        "schema": {
                            "$ref": "#/definitions/utils.Response"
                        }
                    },
        ...
        "/auth/register/resend-otp": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "If this email is eligible for registration, an OTP has been resent",
                        "schema": {
                            "$ref": "#/definitions/utils.Response"
                        }
                    },
        ...
        "/auth/register/set-password": {
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "invalid or expired registration token | password must be at least 12 characters long and include upper, lower, number, and symbol | user with this email already exists",
                        "schema": {
                            "$ref": "#/definitions/utils.Response"
                        }
                    },
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.VerifyRegistrationOTPRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/currencies/{currency_id}/networks": {
            "get": {
        ...
        "/currencies/{currency_id}/price": {
            "get": {
                "description": "Public: get the current market price of a cryptocurrency in Nigerian Naira (NGN) from CoinGecko.\nPublic: returns the fee tiers for fiat withdrawals and per-network fees for crypto withdrawals.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "responses": {
                    ...
                    "404": {
                        "description": "Currency not found or CoinGecko ID not configured",
                        "schema": {
                            "$ref": "#/definitions/utils.Response"
                        }
                    },
        ...
        "/p2p/ads": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Ad type (buy or sell)",
                        "name": "type",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "Crypto currency ID (reference currencies.id)",
                        "name": "currency_id",
                        "in": "query"
                    },
                    {
                        "type": "boolean",
                        "description": "If true, only return my ads",
                        "name": "mine_only",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "P2P ads retrieved successfully",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/utils.PaginatedResponse"
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/handler.P2PAdView"
                                            }
                                        }
                                    }
                                }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.CreateP2PAdRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "P2P ad created successfully",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/utils.Response"
        ...
        "/p2p/ads/{id}": {
            "delete": {
                ...
                "responses": {
                    "204": {
                        "description": "P2P ad deleted successfully"
                    },
                    "400": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.UpdateP2PAdRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "P2P ad updated successfully",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/utils.Response"
        ...
        "/p2p/my-ads": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Ad status (active, paused, closed)",
                        "name": "status",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "My P2P ads retrieved successfully",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/utils.PaginatedResponse"
        ...
        "/p2p/orders": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "P2P orders retrieved successfully",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/utils.PaginatedResponse"
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/handler.P2POrderView"
                                            }
                                        }
                                    }
                                }
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.ExecuteP2PTradeRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "P2P trade executed successfully",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/utils.Response"
                    ...
                    "409": {
                        "description": "Duplicate request in progress",
                        "schema": {
                            "$ref": "#/definitions/utils.Response"
                        }
                    },
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.SubmitReviewRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.DeleteMyAccountRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/users/me/2fa/disable": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "PIN and TOTP code",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.DisableTwoFARequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        "description": "invalid PIN | invalid authenticator code | 2FA not enabled",
                        "schema": {
                            "$ref": "#/definitions/utils.Response"
                        }
                    },
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.EnableTwoFARequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid code or 2FA not initialized",
                        "schema": {
                            "$ref": "#/definitions/utils.Response"
                        }
                    },
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/handler.TwoFASetupResponse"
                                        }
                                    }
                                }
                            ]
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.CryptoWithdrawRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/models.CryptoWithdrawal"
                                        }
                                    }
                                }
                            ]
        ...
        "/users/me/deposit-account": {
            "get": {
                ...
                "description": "Return the user's deposit bank account; if missing, create via Nomba and persist.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "summary": "Get my deposit bank account",
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.ConfirmEmailChangeRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.RequestEmailChangeOTPRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/users/me/fiat-bank-lookup": {
            "post": {
                ...
                "description": "Resolve the account name for a bank account using Nomba's bank lookup.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    {
                        "description": "Bank lookup details",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.FiatBankLookupRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/users/me/fiat-banks": {
            "get": {
                ...
                "description": "Retrieve banks and their codes for fiat withdrawals via Nomba.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/users/me/fiat-withdrawals": {
            "post": {
                ...
                "description": "Initiate a fiat withdrawal to a bank account via Nomba, protected by a 6-digit PIN and 6-digit authenticator (TOTP) code.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.FiatWithdrawRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/models.FiatWithdrawal"
                                        }
                                    }
                                }
                            ]
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.InternalTransferRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/models.InternalTransfer"
                                        }
                                    }
                                }
                            ]
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/models.KYCStatusResponse"
                                        }
                                    }
                                }
                            ]
        ...
        "/users/me/kyc/tier1": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Tier 1 verification details",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.SubmitTier1Request"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Tier 1 verification completed successfully",
                        "schema": {
                            "$ref": "#/definitions/utils.Response"
                        }
                    },
        ...
        "/users/me/kyc/tier2": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Tier 2 verification details",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.SubmitTier2Request"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Tier 2 verification completed successfully",
                        "schema": {
                            "$ref": "#/definitions/utils.Response"
                        }
                    },
        ...
        "/users/me/kyc/tier3": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "file",
                        "description": "Utility bill document (jpg, png, pdf)",
                        "name": "utility_bill",
                        "in": "formData",
                        "required": true
                    },
                ...
                "responses": {
                    "200": {
                        "description": "Tier 3 verification completed successfully",
                        "schema": {
                            "$ref": "#/definitions/utils.Response"
                        }
                    },
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.ChangePINRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        "description": "Validation error or invalid old PIN",
                        "schema": {
                            "$ref": "#/definitions/utils.Response"
                        }
                    },
        ...
        "/users/me/pin/setup": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "PIN setup details",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.SetupPINRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        "description": "Validation error or PIN already configured",
                        "schema": {
                            "$ref": "#/definitions/utils.Response"
                        }
                    },
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/service.ReferralInfo"
                                        }
                                    }
                                }
                            ]
        ...
        "/users/me/wallet-address": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Chain key (e.g. bep20, erc20, trc20)",
                        "name": "chain",
                        "in": "query",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "Currency symbol (e.g. USDT)",
                        "name": "currency",
                        "in": "query",
                        "required": true
                    }
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/handler.WalletAddressResponse"
                                        }
                                    }
                                }
                            ]
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/models.TransactionHistoryItem"
                                            }
                                        }
                                    }
                                }
        ...
        "/users/{id}": {
            ...
            "delete": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid user ID or cannot delete user",
                        "schema": {
                            "$ref": "#/definitions/utils.Response"
                        }
                    },
        ...
        "/withdrawal-fees/crypto": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Network chain key (e.g. erc20, trc20)",
                        "name": "chain",
                        "in": "query",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "Withdrawal fee retrieved",
                        "schema": {
                            "$ref": "#/definitions/utils.Response"
                        }
                    },
                    ...
                    "500": {
                        "description": "Failed to fetch fee",
                        "schema": {
                            "$ref": "#/definitions/utils.Response"
                        }
                    }
    ...
    "definitions": {
        ...
        "handler.BroadcastNotificationRequest": {
            "type": "object",
            "required": [
                "message",
                "title"
        ...
        "handler.ChangePasswordRequest": {
            ...
            "properties": {
                "new_password": {
                    "description": "Enforce strong password policy consistent with registration and reset flows.",
                    "type": "string",
                    "minLength": 12
                },
                "old_password": {
        ...
        "handler.ConfirmEmailChangeRequest": {
            "type": "object",
            "required": [
                "otp"
            ],
        ...
        "handler.CreateCurrencyRequest": {
            ...
            "properties": {
                "asset_id": {
                    "description": "Optional Blockradar asset ID for crypto withdrawals (UUID-like).",
                    "type": "string"
                },
                "coingecko_id": {
                    "description": "Optional CoinGecko coin ID for price fetching (e.g., \"tether\", \"ethereum\").",
                    "type": "string"
                },
                "decimals": {
                    "type": "integer"
        ...
        "handler.CreateP2PAdRequest": {
            ...
            "properties": {
                ...
                "price": {
                    "description": "Required only for price_type=fixed",
                    "type": "string"
                },
                "price_type": {
                    "type": "string"
                ...
                "relative_percent": {
                    "description": "Required only for price_type=relative",
                    "type": "string"
                },
                "rollover_enabled": {
                    "type": "boolean"
        ...
        "handler.CryptoWithdrawRequest": {
            ...
            "properties": {
                ...
                "auth_code": {
                    "description": "6-digit Google Authenticator (TOTP) code. Required only when 2FA is enabled.",
                    "type": "string"
                },
                "chain": {
                    "type": "string"
        ...
        "handler.DeleteMyAccountRequest": {
            "type": "object",
            "required": [
                "password"
            ],
        ...
        "handler.DisableTwoFARequest": {
            ...
            "properties": {
                "code": {
                    "description": "6-digit Google Authenticator (TOTP) code.",
                    "type": "string"
                },
                "pin": {
                    "description": "6-digit transaction PIN.",
        ...
        "handler.ExecuteP2PTradeRequest": {
            "type": "object",
            "required": [
                "ad_id",
                "amount_input",
            ...
            "properties": {
                ...
                "amount_input": {
                    "description": "The amount the user wants to trade, expressed in input_currency.",
                    "type": "string"
                },
                "input_currency": {
                    "description": "\"fiat\" or \"crypto\" — which side amount_input is denominated in.",
                    "type": "string",
                    "enum": [
                        "fiat",
                        "crypto"
        ...
        "handler.ForgotPasswordRequestOTPRequest": {
            "type": "object",
            "required": [
                "email"
            ],
        ...
        "handler.ForgotPasswordResetRequest": {
            "type": "object",
            "required": [
                "new_password",
                "reset_token"
        ...
        "handler.ForgotPasswordVerifyOTPRequest": {
            "type": "object",
            "required": [
                "email",
                "otp"
        ...
        "handler.InternalTransferRequest": {
            "type": "object",
            "required": [
                "amount",
                "currency_id",
        ...
        "handler.P2PAdView": {
            ...
            "properties": {
                ...
                "price_type": {
                    "description": "fixed, relative",
                    "type": "string"
                },
                "relative_percent": {
                    "description": "+/- % of market price when PriceType=relative",
                    "type": "number"
                },
                "remaining_quantity": {
                ...
                "total_quantity": {
                    "description": "total ad capacity when rollover is off",
                    "type": "number"
                },
                "type": {
        ...
        "handler.P2POrderView": {
            ...
            "properties": {
                ...
                "fee_amount": {
                    "description": "FeeAmount and FeeCurrency are the taker fee for this order — the fee\ncharged to the party who created the order (executed against the ad).",
                    "type": "number"
                },
                "fee_currency": {
                    "type": "string"
                ...
                "order_number": {
                    "description": "OrderNumber is a public-facing 20-digit numeric identifier for the order.",
                    "type": "string"
                },
                "price": {
                    "type": "number"
                ...
                "side": {
                    "description": "Side is from the perspective of the authenticated user: \"buy\" if the\nuser bought crypto in this order, \"sell\" if they sold crypto.",
                    "type": "string"
                },
                "status": {
                    "description": "pending, paid, disputed, cancelled, completed",
                    "type": "string"
                },
                "taker_fee_amount": {
                    "type": "number"
                ...
                "type": {
                    "description": "Type indicates whether this is a buy or sell order for crypto (mirrors the ad type).",
                    "type": "string"
                },
                "updated_at": {
                    "type": "string"
        ...
        "handler.RequestEmailChangeOTPRequest": {
            "type": "object",
            "required": [
                "new_email",
                "password"
        ...
        "handler.RequestRegistrationOTPRequest": {
            "type": "object",
            "required": [
                "email"
            ],
        ...
        "handler.UpdateReferralConfigRequest": {
            "type": "object",
            "required": [
                "key",
                "value"
        ...
        "handler.UpsertCommunityLinkRequest": {
            "type": "object",
            "required": [
                "platform",
                "url"
        ...
        "handler.VerifyRegistrationOTPRequest": {
            "type": "object",
            "required": [
                "email",
                "otp"
        ...
        "handler.adminUserDetailResponse": {
            "type": "object",
            "properties": {
                "kyc": {
                    "$ref": "#/definitions/models.KYCStatusResponse"
                ...
                "security": {
                    "$ref": "#/definitions/handler.adminSecurityView"
                },
                "tx_total": {
                    "type": "integer"
                },
        ...
        "models.Currency": {
            ...
            "properties": {
                "asset_id": {
                    "description": "AssetID is the Blockradar asset identifier used for withdrawals (UUID-like string).\nIt is optional because not all currencies need to be withdrawable via Blockradar.",
                    "type": "string"
                },
                "coingecko_id": {
                    "description": "CoinGeckoID is the CoinGecko coin identifier used for price fetching (e.g., \"tether\", \"ethereum\").\nIt is optional and only needed for currencies that support relative pricing in P2P ads.",
                    "type": "string"
                },
                "created_at": {
                    "type": "string"
        ...
        "models.KYCStatusResponse": {
            ...
            "properties": {
                ...
                "next_tier": {
                    "$ref": "#/definitions/models.KYCTier"
                },
                "nin_verified": {
                    "type": "boolean"
                },
        ...
        "models.TransactionHistoryItem": {
            ...
            "properties": {
                ...
                "counterparty": {
                    "description": "Counterparty (sender or receiver, if applicable).",
                    "allOf": [
                        {
                            "$ref": "#/definitions/models.CounterpartyInfo"
                        }
                    ]
                },
                "created_at": {
                ...
                "method": {
                    "description": "\"bank_transfer\", \"internal_transfer\", \"onchain\", \"p2p_trade\", \"referral_reward\"",
                    "type": "string"
                },
                "receipt": {
                    "description": "Receipt holds type-specific details (bank info for fiat, chain info for\ncrypto). It is always present so the client can access receipt fields\nwithout checking a separate level.",
                    "allOf": [
                        {
                            "$ref": "#/definitions/models.TransactionReceipt"
                        }
                    ]
                },
                "status": {
        ...
        "models.TransactionReceipt": {
            ...
            "properties": {
                ...
                "bank_name": {
                    "description": "Fiat-specific fields.",
                    "type": "string"
                },
                "network": {
                    "type": "string"
        ...
        "models.UserProfile": {
            ...
            "properties": {
                ...
                "first_name": {
                    "description": "KYC-related profile fields",
                    "type": "string"
                },
                "full_name": {
                    "type": "string"
        ...
        "models.WalletTransaction": {
            ...
            "properties": {
                ...
                "crypto_deposit": {
                    "$ref": "#/definitions/models.CryptoDeposit"
                },
                "crypto_deposit_id": {
                    "type": "string"
                },
                ...
                "currency": {
                    "description": "Currency is not stored in this table; it is populated from the parent\nwallet at query time via a JOIN.",
                    "type": "string"
                },
                "description": {
                    "type": "string"
                ...
                "fiat_deposit": {
                    "$ref": "#/definitions/models.FiatDeposit"
                },
                "fiat_deposit_id": {
                    "type": "string"
                },
                ...
                "type": {
                    "description": "deposit, withdrawal, trade, fee, escrow_lock",
                    "type": "string"
                },
                "updated_at": {
                    "type": "string"
        ...
        "repository.FinancialSummary": {
            "type": "object",
            "properties": {
                "pending_crypto_deposits": {
                    "$ref": "#/definitions/repository.CountAmount"
                },
                "pending_fiat_deposits": {
                    "$ref": "#/definitions/repository.CountAmount"
                },
                "processing_crypto_withdrawals": {
                    "$ref": "#/definitions/repository.CountAmount"
                },
                "processing_fiat_withdrawals": {
                    "$ref": "#/definitions/repository.CountAmount"
                },
                "wallet_balances": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/repository.WalletBalanceSummary"
                    }
                }
            }
        },
        "repository.OrderStats": {
            "type": "object",
            "properties": {
                "cancelled_orders": {
                    "type": "integer"
                ...
                "total_volume": {
                    "description": "sum of completed order totals (fiat)",
                    "type": "number"
                }
            }
        },
        "repository.WalletBalanceSummary": {
            "type": "object",
            "properties": {
                "currency": {
                    "type": "string"
        ...
        "repository.WalletDiscrepancy": {
            ...
            "properties": {
                ...
                "discrepancy": {
                    "description": "stored - tx_net",
                    "type": "number"
                },
                "stored_balance": {
                    "description": "from wallets.balance (converted)",
                    "type": "number"
                },
                "tx_count": {
                    "type": "integer"
                ...
                "tx_net_balance": {
                    "description": "SUM(balance_after - balance_before)",
                    "type": "number"
                },
                "user_email": {
                    "type": "string"
        ...
        "repository.WalletVerificationResult": {
            "type": "object",
            "properties": {
                "discrepancies": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/repository.WalletDiscrepancy"
                    }
                },
                "discrepancy_count": {
                    "type": "integer"
        ...
        "service.AdminP2POrderResponse": {
            ...
            "properties": {
                ...
                "buyer": {
                    "$ref": "#/definitions/service.AdminOrderParty"
                },
                "buyer_id": {
                    "type": "string"
                },
        ...
        "service.RevenueSummary": {
            ...
            "properties": {
                "fee_balances": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.PlatformFeeBalance"
                    }
                },
                "order_stats": {
                    "$ref": "#/definitions/repository.OrderStats"
                }
            }
        },
        "service.UserLimitInfo": {
            "type": "object",
            "properties": {
                "effective_limit_ngn": {
                    "type": "integer"
                ...
                "override_limit_ngn": {
                    "description": "null when no override",
                    "type": "integer"
                },
                "remaining_ngn": {
                    "type": "integer"
