      ...
      <div className="bg-white rounded-2xl border border-gray-100 p-5">
        ...
        <div className="space-y-4">
          {[
            ...
            { icon: Wallet,     title: "They earn #1,000 on their first deposit if it is $10 or above", desc: "First qualifying deposit" },
                ...
                return (
                  <div key={i}>
                    <div className="flex items-center gap-3 px-4 py-3.5">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-sm font-semibold text-[#1D3B53]">{entry.username}</p>
